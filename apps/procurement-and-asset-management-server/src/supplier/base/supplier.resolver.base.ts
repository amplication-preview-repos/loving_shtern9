...
export class SupplierResolverBase {
  ...
  @graphql.ResolveField(() => [ProcurementRequest], {
  ...
  async findProcurementRequests(
    ...
    const results = await this.service.findProcurementRequests(parent.id, args);
  ...
  @graphql.ResolveField(() => [PurchaseOrder], { name: "purchaseOrders" })
